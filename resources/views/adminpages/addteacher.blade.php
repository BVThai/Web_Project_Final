            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Thêm giáo viên</a></li>
                    </ol>
                </div>
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="needs-validation" action="{{ route('ad_add_teacher') }}" method="post" enctype="multipart/form-data" novalidate="">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <?php
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name='hovatengiaovien' id="validationCustom01" placeholder="Nguyễn Văn A" required="">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name='diachi' id="validationCustom01" placeholder="112, xxx, xxxx" required="">
                                                        <div class="invalid-feedback">
                                                            Vui lòng nhập tên.
                                                        </div>
                                                    </div>
